...
import static io.smilo.commons.peer.payloadhandler.PayloadType.REQUEST_NET_STATE;

@Component
public class BlockSyncer {

    private static final Logger LOGGER = Logger.getLogger(BlockSyncer.class);

    private final INetworkState networkState;
    private final BlockStore blockStore;
    private final PeerClient peerClient;

    public BlockSyncer(INetworkState networkState, BlockStore blockStore, PeerClient peerClient) {
    ...
    public void broadcastNewBlockRequest() {
        // TODO: make this efficient and fault tolerant SMIL-160

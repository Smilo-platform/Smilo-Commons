...
public class TransactionSigningTest  extends AbstractSpringTest {
    ...
    public void testIsValidWrongMerkleSignature() {
        Transaction transaction = new Transaction(1527514557052L, "000x00123", AccountBuilder.TEST_S1, BigInteger.valueOf(10L), BigInteger.ZERO,
                Arrays.asList(new TransactionOutput(AccountBuilder.TEST_S2, BigInteger.valueOf(10L))),
                "",
    ...
    public void testIsValidTransaction() {
        Transaction transaction = new Transaction(1527514557052L, "000x00123", AccountBuilder.ELKAN, BigInteger.valueOf(10L), BigInteger.ZERO,
                Arrays.asList(new TransactionOutput(AccountBuilder.TEST_S2, BigInteger.valueOf(10L))),
                "",
                "424045E72D0DB035D3E41EDFC447765D18167F04FD11AD15656082067F18B5A6",
                "", 0L);
